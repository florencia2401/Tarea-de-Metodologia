...
const updateUsuarioSchema = Joi.object({ // define las reglas que debe cumplir para actualizar*/
  // Ayudita: Usa las mismas validaciones de arriba pero con required() removido
  nombre: Joi.string().min(3).max(30).optional(),
  apellido: Joi.string().min(3).max(30).optional(),
